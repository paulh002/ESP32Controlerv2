...
void mainTab::init(lv_obj_t* tabview_tab, lv_group_t* button_group)
{
...
void mainTab::setPowerValue(double pwrValue)
{
	std::string value;
...
void mainTab::setSwrValue(uint16_t swrValue)
{
	char buf[32];
...
void mainTab::barValue(double value)
{
